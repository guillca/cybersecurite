...
export const INITIAL_SCHEDULED_POSTS: Post[] = [
  { 
    id: 1, 
    emitter: 'Usager', 
    handle: '@marie_p', 
  ...
  { 
    ...
    handle: '@InfosVille', 
    message: 'Alerte : perturbations massives signalées à l’hôpital central, services administratifs touchés. Nous recherchons des précisions.', 
    time: 12, 
  ...
  { 
    ...
    handle: '@ActuRegion', 
    message: 'Plusieurs rendez-vous annulés cet après-midi à l’hôpital central. Les patients sont priés de contacter leur médecin traitant.', 
    time: 50, 
